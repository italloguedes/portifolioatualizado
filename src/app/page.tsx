    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="flex flex-col items-center justify-center min-h-[80vh] text-center relative">
        ...
        <div className="relative flex flex-col items-center justify-center">
          <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
            <div className="relative w-48 h-48 rounded-full overflow-hidden ring-4 ring-blue-500/50">
              <Image
                src="/profile.jpg"
                alt="Foto de perfil"
                fill
          ...
          <div className="flex gap-4">
            <Link
              href="#projetos"
              className="group relative px-6 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-all duration-300"
            >
            ...
            <Link
              href="#contato"
              className="px-6 py-3 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors"
            >
              Contato
            </Link>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-4 bg-gray-700/30 rounded-lg">
                <h3 className="text-lg font-semibold text-blue-400 mb-2">Soluções Personalizadas</h3>
                <p className="text-gray-300">Desenvolvimento sob medida para suas necessidades específicas</p>
              </div>
              <div className="p-4 bg-gray-700/30 rounded-lg">
                <h3 className="text-lg font-semibold text-purple-400 mb-2">Tecnologias Modernas</h3>
                <p className="text-gray-300">Utilização das mais recentes tecnologias do mercado</p>
              </div>
              <div className="p-4 bg-gray-700/30 rounded-lg">
                <h3 className="text-lg font-semibold text-blue-400 mb-2">Resultados Reais</h3>
                <p className="text-gray-300">Foco em entregar valor e resultados para seu negócio</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            <div className="relative mb-12">
              <div className="flex items-center">
                <div className="w-1/2 pr-8 text-right">
                  <h3 className="text-xl font-bold text-blue-400">Início dos Estudos</h3>
                  <p className="text-gray-300">Janeiro 2024</p>
            ...
            <div className="relative mb-12">
              <div className="flex items-center">
                ...
                <div className="w-1/2 pl-8">
                  <h3 className="text-xl font-bold text-purple-400">Análise de Dados com Python</h3>
                  <p className="text-gray-300">Dezembro 2024</p>
            ...
            <div className="relative mb-12">
              <div className="flex items-center">
                <div className="w-1/2 pr-8 text-right">
                  <h3 className="text-xl font-bold text-blue-400">Desenvolvimento Web Avançado</h3>
                  <p className="text-gray-300">Junho 2024</p>
            ...
            <div className="relative mb-12">
              <div className="flex items-center">
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-purple-500 rounded-full"></div>
                <div className="w-1/2 pl-8">
                  <h3 className="text-xl font-bold text-purple-400">Desenvolvimento Full Stack</h3>
                  <p className="text-gray-300">2024 - Presente</p>
            ...
            <div className="relative">
              <div className="flex items-center">
                <div className="w-1/2 pr-8 text-right">
                  <h3 className="text-xl font-bold text-blue-400">Formação</h3>
      ...
      <section id="projetos" className="py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group bg-gray-800/50 backdrop-blur-sm rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300 border border-gray-700/50">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-2 text-blue-400">Site da Dra. Neirilane Aragão</h3>
          ...
          <div className="group bg-gray-800/50 backdrop-blur-sm rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300 border border-gray-700/50">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-2 text-blue-400">Allcessorios</h3>
              <p className="text-gray-300 mb-4">
          ...
          <div className="group bg-gray-800/50 backdrop-blur-sm rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300 border border-gray-700/50">
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-2 text-blue-400">Bots de Telegram</h3>
              <p className="text-gray-300 mb-4">
