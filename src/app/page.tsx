    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="flex flex-col items-center justify-center min-h-[80vh] text-center relative">
        ...
        <div className="relative">
          <div className="relative w-32 h-32 mb-8 rounded-full overflow-hidden ring-4 ring-blue-500/50">
            <Image
              src="/profile.jpg"
              alt="Foto de perfil"
              fill
          ...
          <p className="text-xl text-gray-300 mb-8">
            Desenvolvedor full stack há 1 ano, criando soluções com Python/FastAPI no backend e Next.js com JavaScript no frontend
          </p>
